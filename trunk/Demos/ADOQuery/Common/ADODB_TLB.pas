...
// $Rev: 8291 $
// File generated on 2014-2-20 15:30:04 from Type Library described below.
...
//   Error creating palette bitmap of (TRecord_) : Server C:\Program Files\Common Files\System\ado\msado15.dll contains no icons
...
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TRecord_Properties= class;
{$ENDIF}
  TRecord_ = class(TOleServer)
  private
    FIntf: _Record;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TRecord_Properties;
    function GetServerProperties: TRecord_Properties;
{$ENDIF}
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TRecord_Properties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TRecord_Properties = class(TPersistent)
  private
    FServer:    TRecord_;
    function    GetDefaultInterface: _Record;
    constructor Create(AServer: TRecord_);
  protected
    function Get_ActiveConnection: OleVariant;
    procedure Set_ActiveConnection(const pvar: WideString);
    procedure _Set_ActiveConnection(const pvar: _Connection);
...
procedure TRecord_.InitServerData;
const
  CServerData: TServerData = (
...
procedure TRecord_.ConnectTo(svrIntf: _Record);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TRecord_.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TRecord_.GetDefaultInterface: _Record;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TRecord_Properties.Create(Self);
{$ENDIF}
end;
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TRecord_.GetServerProperties: TRecord_Properties;
begin
  Result := FProps;
end;
{$ENDIF}

function TRecord_.Get_ActiveConnection: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TRecord_.Set_ActiveConnection(const pvar: WideString);
...
procedure TRecord_._Set_ActiveConnection(const pvar: _Connection);
  { Warning: The property ActiveConnection has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TRecord_.Get_State: ObjectStateEnum;
begin
    Result := DefaultInterface.State;
end;

function TRecord_.Get_Source: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TRecord_.Set_Source(const pvar: WideString);
...
procedure TRecord_._Set_Source(const pvar: IDispatch);
  { Warning: The property Source has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TRecord_.Get_Mode: ConnectModeEnum;
begin
    Result := DefaultInterface.Mode;
end;

procedure TRecord_.Set_Mode(pMode: ConnectModeEnum);
begin
  DefaultInterface.Set_Mode(pMode);
end;

function TRecord_.Get_ParentURL: WideString;
begin
    Result := DefaultInterface.ParentURL;
end;

function TRecord_.Get_Fields: Fields;
begin
    Result := DefaultInterface.Fields;
end;

function TRecord_.Get_RecordType: RecordTypeEnum;
begin
    Result := DefaultInterface.RecordType;
end;

function TRecord_.MoveRecord(const Source: WideString; const Destination: WideString; 
                             const UserName: WideString; const Password: WideString; 
                             Options: MoveRecordOptionsEnum; Async: WordBool): WideString;
begin
...
function TRecord_.CopyRecord(const Source: WideString; const Destination: WideString; 
                             const UserName: WideString; const Password: WideString; 
                             Options: CopyRecordOptionsEnum; Async: WordBool): WideString;
begin
...
procedure TRecord_.DeleteRecord(const Source: WideString; Async: WordBool);
begin
  DefaultInterface.DeleteRecord(Source, Async);
end;

procedure TRecord_.Open(Source: OleVariant; ActiveConnection: OleVariant; Mode: ConnectModeEnum; 
                        CreateOptions: RecordCreateOptionsEnum; Options: RecordOpenOptionsEnum; 
                        const UserName: WideString; const Password: WideString);
begin
...
procedure TRecord_.Close;
begin
  DefaultInterface.Close;
end;

function TRecord_.GetChildren: _Recordset;
begin
  Result := DefaultInterface.GetChildren;
end;

procedure TRecord_.Cancel;
begin
  DefaultInterface.Cancel;
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TRecord_Properties.Create(AServer: TRecord_);
begin
  inherited Create;
  FServer := AServer;
end;

function TRecord_Properties.GetDefaultInterface: _Record;
begin
  Result := FServer.DefaultInterface;
end;

function TRecord_Properties.Get_ActiveConnection: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TRecord_Properties.Set_ActiveConnection(const pvar: WideString);
  { Warning: The property ActiveConnection has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
procedure TRecord_Properties._Set_ActiveConnection(const pvar: _Connection);
  { Warning: The property ActiveConnection has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TRecord_Properties.Get_State: ObjectStateEnum;
begin
    Result := DefaultInterface.State;
end;

function TRecord_Properties.Get_Source: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TRecord_Properties.Set_Source(const pvar: WideString);
  { Warning: The property Source has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
procedure TRecord_Properties._Set_Source(const pvar: IDispatch);
  { Warning: The property Source has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TRecord_Properties.Get_Mode: ConnectModeEnum;
begin
    Result := DefaultInterface.Mode;
end;

procedure TRecord_Properties.Set_Mode(pMode: ConnectModeEnum);
begin
  DefaultInterface.Set_Mode(pMode);
end;

function TRecord_Properties.Get_ParentURL: WideString;
begin
    Result := DefaultInterface.ParentURL;
end;

function TRecord_Properties.Get_Fields: Fields;
begin
    Result := DefaultInterface.Fields;
end;

function TRecord_Properties.Get_RecordType: RecordTypeEnum;
begin
    Result := DefaultInterface.RecordType;
end;
...
procedure Register;
begin
  RegisterComponents(dtlServerPage, [TConnection, TRecord_, TStream, TCommand, 
